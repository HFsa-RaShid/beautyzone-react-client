...
const UpdateProductModal = ({ isOpen, onClose, product, refetch }) => {
  ...
  <div className="mb-4">
    ...
    <input {...register("name")} className="w-full border p-3 rounded-xl" />
  </div>
 ...
 <div className="grid grid-cols-2 gap-4 mb-4">
  ...
  {/* Additional Fields */}
  <div className="mb-4">
    <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Straight Up</label>
    <input {...register("STRAIGHT_UP")} className="w-full border p-3 rounded-xl" />
  </div>

  <div className="mb-4">
    <label className="block text-xs font-bold text-gray-500 uppercase mb-1">The Lowdown</label>
    <input {...register("THE_LOWDOWN")} className="w-full border p-3 rounded-xl" />
  </div>
  ...
  <div className="flex gap-3 justify-end">
    ...
    <button type="submit" className="bg-black text-white px-8 py-2 rounded-xl">Update</button>
  </div>
</form>
    </div>
  );
